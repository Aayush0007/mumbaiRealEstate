...
{/* <meta name="description" content="Learn about Living Luxura, your trusted partner for luxury real estate in 2025. Discover exclusive properties, modern homes, and exceptional living spaces in prime city locations." /> */}
{/* <meta name="keywords" content="luxury real estate 2025, exclusive properties, modern homes, Living Luxura, luxury living, dream homes, city apartments, villas, real estate experts" /> */}
  ...
  return (
    <Section id="about" className="bg-white py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          From luxurious city apartments to serene villas, we specialize in connecting discerning buyers with modern homes that inspire. Discover a lifestyle that’s as extraordinary as you are with Living Luxura—your trusted partner in luxury living.
        </motion.p>
